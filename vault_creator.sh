...
create_dir "$VAULT_NAME/📥 Inbox/Transit Notes"
create_dir "$VAULT_NAME/🗂️ Categorized"
create_dir "$VAULT_NAME/🗂️ Categorized/Personal"
create_dir "$VAULT_NAME/🗂️ Categorized/Professional"
create_dir "$VAULT_NAME/🗂️ Categorized/Learning"
create_dir "$VAULT_NAME/🗂️ Categorized/Books"
